function StreamSliceMovie(Uplot,Vplot,Wplot,Nx,Ny,Nz,time)
%Streamslicemovie
streamsliceWriter = VideoWriter(['C:\Users\fredd\OneDrive\Skrivbord\flowfilms\Streamslice_'  num2str(time,'%.2f')], 'MPEG-4');
