...
elseif strcmp(wall,'roof')
    X( horizontal_bounds, vertical_bounds, end) = reshape(Xmag, shapeRF) - X(horizontal_bounds ,vertical_bounds, end-1);
elseif strcmp(wall,'floor')
    X( horizontal_bounds, vertical_bounds, 1) = reshape(Xmag, shapeRF) - X(horizontal_bounds ,vertical_bounds, 2);
end
