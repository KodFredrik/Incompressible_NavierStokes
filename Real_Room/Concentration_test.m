...
movieVector2(timesteps/data_interval) = struct('cdata',[],'colormap',[]);
...
%load velocity field
load('C:\Users\fredd\OneDrive\Dokument\MATLAB\Real_room\KanonVel.mat')
...
ylabel(axh, 'Y')
zlabel(axh, 'Z')
movieVector2(i/data_interval) = getframe(f6, [10 50 990 740]);
pause(0.05)
end
