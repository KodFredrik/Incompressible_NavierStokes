function movieVectorC = concentrationMovie(Xi,Nx,Ny,Nz,time, Re, Sc, strength, movieVector2, path)
[X,Y,Z] = meshgrid(1:Nx,1:Ny,1:Nz);
pressureWriter = VideoWriter([path '\Con_scatter_' num2str(time,'%.2f')], 'MPEG-4');
