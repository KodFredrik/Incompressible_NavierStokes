...
%This function sets dirichlet boundary conditions at the walls for the
%velocity arrays. It concatenates the arrays with interior points with
%another layer, thus increasing U from N-1 x N x N points to
% N+1 x N+2 x N+2 and similarly for V and W.

%Zero Dirichlet for the walls (no-slip)
C_Ue = 0;
C_Uw = 0;
C_Un = 0;
C_Us = 0;
...
%Sets Dirichlet everywhere for U
lenU = size(U);
